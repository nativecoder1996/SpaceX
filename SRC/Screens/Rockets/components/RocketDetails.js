  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Image source={{ uri: data.flickr_images[1] }} style={styles.image} />
        <TouchableOpacity style={styles.icon} onPress={() => navigation.goBack()}>
          <SvgXml xml={leftArrow} width={20} height={16} />
        </TouchableOpacity>
      </View>
      <Image source={{ uri: data.flickr_images[0] }} style={styles.logo} />
      <View style={styles.headerText}>
        <Text style={styles.title}>{data.name}</Text>
        <View style={styles.subTitle}>
          <Text style={styles.subTitleText}>{data.company}</Text>
          <Text style={styles.subTitleText}>|</Text>
          <Text style={styles.subTitleText}>{data.country}</Text>
        </View>
      </View>
      <ScrollView style={{ width: '100%', marginBottom: 70 }}>
        ...
        <View style={styles.ProfileLink}>
          ...
          <TouchableOpacity style={{ marginLeft: 10 }}>
            <Text style={styles.text5}>{data.wikipedia}</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.RocketDetails}>
          <Text style={styles.text6}>Overview</Text>
          <View style={styles.RocketDetailsView}>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Height</Text>
              <Text style={styles.text8}>{data.height.meters} m</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Diameter</Text>
              <Text style={styles.text8}>{data.diameter.meters} m</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Mass</Text>
              <Text style={styles.text8}>{data.mass.kg} kg</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>First Flight</Text>
              <Text style={styles.text8}>{data.first_flight}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Cost Per Launch</Text>
              <Text style={styles.text8}>$ {data.cost_per_launch}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Success Rate</Text>
              <Text style={styles.text8}>{data.success_rate_pct}%</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Country</Text>
              <Text style={styles.text8}>{data.country}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Company</Text>
              <Text style={styles.text8}>{data.company}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Active</Text>
              <Text style={styles.text8}>{data.active ? 'Yes' : 'No'}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Stages</Text>
              <Text style={styles.text8}>{data.stages}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Boosters</Text>
              <Text style={styles.text8}>{data.boosters}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>First Stage</Text>
              <Text style={styles.text8}>{data.first_stage.reusable ? 'Yes' : 'No'}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Second Stage</Text>
              <Text style={styles.text8}>{data.second_stage.reusable ? 'Yes' : 'No'}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Engines</Text>
              <Text style={styles.text8}>{data.engines.number}</Text>
            </View>
            <View style={styles.line}></View>
            <View style={styles.RocketDetailsView1}>
              <Text style={styles.text7}>Type</Text>
              <Text style={styles.text8}>{data.engines.type}</Text>
            </View>
            <View style={styles.line}></View>
            {data.engines.version && (
              <>
                <View style={styles.RocketDetailsView1}>
                  <Text style={styles.text7}>Version</Text>
                  <Text style={styles.text8}>{data.engines.version}</Text>
                </View>
                <View style={styles.line}></View>
              </>
            )}
            {data.engines.layout && (
              <>
                <View style={styles.RocketDetailsView1}>
                  <Text style={styles.text7}>Layout</Text>
                  <Text style={styles.text8}>{data.engines.layout}</Text>
                </View>
              </>
            )}
          </View>
...
const styles = StyleSheet.create({
  ...
  text6: {
    ...
    fontFamily: Platform.OS === 'ios' ? fontfamily.fontRegular : fontfamily.fontRegular2,
  },
  RocketDetailsView: {
    marginRight: 20,
  },
