import { StyleSheet, Text, View, TouchableOpacity, SafeAreaView, Image, ScrollView, Linking } from 'react-native'
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Image source={{ uri: data1.flickr_images[1] }} style={styles.image} />
            ...
            <View style={styles.headerText}>
                ...
                <View style={styles.subTitle}>
                    ...
                    <Text style={styles.subTitleText}>{data1.first_flight}</Text>
                </View>
            </View>
            <ScrollView style={styles.scroll}>
                ...
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Description : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.description}</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Type : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.type}</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Mass : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.dry_mass_kg} kg</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Height : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.height_w_trunk.meters} m</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Diameter : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.diameter.meters} m</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>First Flight : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.first_flight}</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Heat Shield : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.heat_shield.material}</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Thrust : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.thrusters[0].thrust.kN} kN</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Trunk : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.trunk.trunk_volume.cubic_meters} m3</Text>
                </View>
                <View style={styles.DragonDetails}>
                    <Text style={styles.DragonDetailsText}>Trunk Cargo : </Text>
                    <Text style={styles.DragonDetailsText1}>{data1.trunk.cargo.solar_array} Solar Array</Text>
                </View>
            </ScrollView>
        </View>
    )
